...
import { getChatRooms, getChatRoomMessages } from "../../services/api/requests";
    ...
    <div className="chat-room-page">
      ...
      <div className="chat-box">
        <div className="col-12 mb-10">
          <div className="row">
            <div className="col-2"><b>Sender Name</b></div>
            <div className="col"><strong>Message</strong></div>
            <div className="col-3"><b>Sent On</b></div>
          </div>
        </div>
        {messages.map((m, i) => {
          return (
